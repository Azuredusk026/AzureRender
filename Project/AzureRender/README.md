...
quality gate are complete. AR-1 through AR-5.6 are complete: typed CLI
contracts, atomic `.azscene` save, unified runtime logging, GPU report
...
fixed AR queue is complete. CQ-0 evidence is
