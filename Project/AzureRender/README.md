...
quality gate are complete. AR-1 through AR-4.3 extension registries are
complete; AR-4.4 is the next implementation task.
...
fixed task is AR-4.4 cross-platform CI. CQ-0 evidence is
