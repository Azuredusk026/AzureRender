...
quality gate are complete. AR-1 through AR-4.2 runtime resource location are
complete; AR-4.3 is the next implementation task.
...
fixed task is AR-4.3 extension registries. CQ-0 evidence is
