...
> 计划版本：2026-08-16 v7
> 当前节点：v6 队列进行中（AR-10.0 接口冻结 Complete；AR-10.1 角色路径迁移 Complete；BH-1 Active）
...
| 3 | BH-1 | Active | `BlackholeSceneRenderer`：全屏追踪 pass + 星空背景 + 纯黑洞，`--scene-type blackhole` 可用 | AR-10.1 | `feat(bh): 黑洞渲染器基础追踪` |
